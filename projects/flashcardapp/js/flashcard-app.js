...
var flashcards = [
  ...
  },
  {
    ...
    answer:
      "A two-dimensional array is an array within an array. If you fill this array with another array you get a three-dimensional array and so on. Example: var multidimensionalArray = [[1,2,3],[4,5,6],[7,8,9]] // two dimensions, 3x3",
  },
  {
  ...
  },
  {
    ...
    answer: "False because the second expression is false.",
  },
  {
  ...
  {
    question:
      "What's the output of this boolean expression: 'if(!false && ( false || (false && true) ))' ",
    answer:
      "False because-----> !false && ( false || (false && true) ) >>>!false && ( false || false) - becomes >>>true && false , which is false",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Operators that first << increase the value of the variable by 1 (increment) or decrease the value of an expression / variable by 1 (decrement) >> and then return this incremented / decremented value.",
  },
  {
    question: "What's postfix increment/decrement?",
    answer:
      "Operators are operators that first return the << value of the variable >> and then increase the value of that variable by 1 (increment) or decrease the value of the variable by 1 (decrement) .",
  },
  {
    question: "What's the main functionality of having classes in OOP?",
    answer:
      "You can use classes as a template to create many objects with similar qualities. Classes are a fundamental component of object-oriented programming (OOP) ",
  },
];
